...
MyChannelHandler.prototype.deliver = function(params, playlist, callback) {
	...
	// **************************************************
	// for every type of post, we need to do the following function with
	// the post is returned in the callback from tumblr.
	// var feedbackItem = ContentFeedback.translateFeedback(feedbackId, fromId, fromName, message, time);
...
MyChannelHandler.prototype.getFeedback = function(params, callback) {
	...
	this.client.posts(blogName, options, function (err, data) {
		console.log(err);
		console.log(data);
	});
...
MyChannelHandler.prototype.remove = function(scInstances, callback) {
	...
	this.client.deletePost(blogName, postID, function (err, data) {
		console.log(err);
		console.log(data);
	});
